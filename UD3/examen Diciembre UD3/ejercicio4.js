 ...
 */
{
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        titulo.appendChild( document.createTextNode( "Numeritos a tutiplén desde cero" ) );
        ...
        respuesta.innerHTML += `<p>Media de los pares:</p>`;
        respuesta.innerHTML += muestra( media );

        // enlace atrás
        let atras = document.createElement( "button" );
        atras.id = "atras";
        atras.appendChild( document.createTextNode("Atrás") );
